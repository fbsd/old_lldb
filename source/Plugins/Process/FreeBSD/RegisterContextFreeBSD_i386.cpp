...
#define GPR_OFFSET(regname) \
    (offsetof(RegisterContextFreeBSD_i386::UserArea, regs) + \
     offsetof(RegisterContextFreeBSD_i386::GPR, regname))

// Computes the offset of the given FPR in the user data area.
#define FPR_OFFSET(regname) \
    (offsetof(RegisterContextFreeBSD_i386::UserArea, i387) + \
     offsetof(RegisterContextFreeBSD_i386::FPU, regname))

// Number of bytes needed to represent a GPR.
#define GPR_SIZE(reg) sizeof(((RegisterContextFreeBSD_i386::GPR*)NULL)->reg)

// Number of bytes needed to represent a FPR.
#define FPR_SIZE(reg) sizeof(((RegisterContextFreeBSD_i386::FPU*)NULL)->reg)

// Number of bytes needed to represent the i'th FP register.
#define FP_SIZE sizeof(((RegisterContextFreeBSD_i386::MMSReg*)NULL)->bytes)

// Number of bytes needed to represent an XMM register.
#define XMM_SIZE sizeof(RegisterContextFreeBSD_i386::XMMReg)
...
RegisterContextFreeBSD_i386::RegisterContextFreeBSD_i386(Thread &thread,
...
ProcessMonitor &
RegisterContextFreeBSD_i386::GetMonitor()
{
...
void
RegisterContextFreeBSD_i386::Invalidate()
{
}

void
RegisterContextFreeBSD_i386::InvalidateAllRegisters()
{
}
...
const RegisterInfo *
RegisterContextFreeBSD_i386::GetRegisterInfoAtIndex(uint32_t reg)
{
...
size_t
RegisterContextFreeBSD_i386::GetRegisterSetCount()
{
    return k_num_register_sets;
}

const RegisterSet *
RegisterContextFreeBSD_i386::GetRegisterSet(uint32_t set)
{
...
bool
RegisterContextFreeBSD_i386::ReadRegister(const RegisterInfo *reg_info,
                                        RegisterValue &value)
{
...
bool
RegisterContextFreeBSD_i386::ReadAllRegisterValues(DataBufferSP &data_sp)
{
    return false;
}

bool RegisterContextFreeBSD_i386::WriteRegister(const RegisterInfo *reg_info,
...
bool
RegisterContextFreeBSD_i386::WriteAllRegisterValues(const DataBufferSP &data)
{
    return false;
}

bool
RegisterContextFreeBSD_i386::UpdateAfterBreakpoint()
{
...
uint32_t
RegisterContextFreeBSD_i386::ConvertRegisterKindToRegisterNumber(uint32_t kind,
                                                               uint32_t num)
{
...
bool
RegisterContextFreeBSD_i386::HardwareSingleStep(bool enable)
{
...
bool
RegisterContextFreeBSD_i386::ReadGPR()
{
     ProcessMonitor &monitor = GetMonitor();
...
bool
RegisterContextFreeBSD_i386::ReadFPR()
{
    ProcessMonitor &monitor = GetMonitor();
