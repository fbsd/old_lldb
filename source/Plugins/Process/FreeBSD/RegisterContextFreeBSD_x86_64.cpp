...
#define GPR_OFFSET(regname) \
    (offsetof(RegisterContextFreeBSD_x86_64::UserArea, regs) + \
     offsetof(RegisterContextFreeBSD_x86_64::GPR, regname))

// Computes the offset of the given FPR in the user data area.
#define FPR_OFFSET(regname) \
    (offsetof(RegisterContextFreeBSD_x86_64::UserArea, i387) + \
     offsetof(RegisterContextFreeBSD_x86_64::FPU, regname))

// Number of bytes needed to represent a GPR.
#define GPR_SIZE(reg) sizeof(((RegisterContextFreeBSD_x86_64::GPR*)NULL)->reg)

// Number of bytes needed to represent a FPR.
#define FPR_SIZE(reg) sizeof(((RegisterContextFreeBSD_x86_64::FPU*)NULL)->reg)

// Number of bytes needed to represent the i'th FP register.
#define FP_SIZE sizeof(((RegisterContextFreeBSD_x86_64::MMSReg*)NULL)->bytes)

// Number of bytes needed to represent an XMM register.
#define XMM_SIZE sizeof(RegisterContextFreeBSD_x86_64::XMMReg)
...
#define REG_CONTEXT_SIZE (sizeof(RegisterContextFreeBSD_x86_64::GPR) + sizeof(RegisterContextFreeBSD_x86_64::FPU))
...
RegisterContextFreeBSD_x86_64::RegisterContextFreeBSD_x86_64(Thread &thread,
                                                         uint32_t concrete_frame_idx)
    : RegisterContextFreeBSD(thread, concrete_frame_idx)
{
}
...
ProcessMonitor &
RegisterContextFreeBSD_x86_64::GetMonitor()
{
    ProcessFreeBSD *process = static_cast<ProcessFreeBSD*>(CalculateProcess());
    return process->GetMonitor();
}

void
RegisterContextFreeBSD_x86_64::Invalidate()
{
}

void
RegisterContextFreeBSD_x86_64::InvalidateAllRegisters()
{
}

size_t
RegisterContextFreeBSD_x86_64::GetRegisterCount()
{
    return k_num_registers;
}

const RegisterInfo *
RegisterContextFreeBSD_x86_64::GetRegisterInfoAtIndex(uint32_t reg)
{
...
size_t
RegisterContextFreeBSD_x86_64::GetRegisterSetCount()
{
    return k_num_register_sets;
}

const RegisterSet *
RegisterContextFreeBSD_x86_64::GetRegisterSet(uint32_t set)
{
...
bool
RegisterContextFreeBSD_x86_64::ReadRegister(const RegisterInfo *reg_info,
                                          RegisterValue &value)
{
...
bool
RegisterContextFreeBSD_x86_64::ReadAllRegisterValues(DataBufferSP &data_sp)
{
...
bool
RegisterContextFreeBSD_x86_64::WriteRegister(const lldb_private::RegisterInfo *reg_info,
...
bool
RegisterContextFreeBSD_x86_64::WriteAllRegisterValues(const DataBufferSP &data_sp)
{
...
bool
RegisterContextFreeBSD_x86_64::UpdateAfterBreakpoint()
{
...
uint32_t
RegisterContextFreeBSD_x86_64::ConvertRegisterKindToRegisterNumber(uint32_t kind,
                                                                 uint32_t num)
{
...
bool
RegisterContextFreeBSD_x86_64::HardwareSingleStep(bool enable)
{
...
bool
RegisterContextFreeBSD_x86_64::ReadGPR()
{
     ProcessMonitor &monitor = GetMonitor();
...
bool
RegisterContextFreeBSD_x86_64::ReadFPR()
{
    ProcessMonitor &monitor = GetMonitor();
...
bool
RegisterContextFreeBSD_x86_64::WriteGPR()
{
     ProcessMonitor &monitor = GetMonitor();
...
bool
RegisterContextFreeBSD_x86_64::WriteFPR()
{
    ProcessMonitor &monitor = GetMonitor();
