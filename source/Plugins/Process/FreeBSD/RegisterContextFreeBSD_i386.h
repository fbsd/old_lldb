...
// Project includes
#include "RegisterContextFreeBSD.h"

class RegisterContextFreeBSD_i386 : public RegisterContextFreeBSD
{
public:
    RegisterContextFreeBSD_i386(lldb_private::Thread &thread,
...
#endif // #ifndef liblldb_RegisterContextFreeBSD_i386_h_
